package com.example.sparkchaindemo.llm.online_llm.raasr;
 ...
 * 2024-12-17
 * **********************************/
public class RAASRLLMActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String audioPath = "/sdcard/iflytek/asr/cn.pcm";
    ...
    RAASRCallbacks mRAASRCallbacks = new RAASRCallbacks() {
        ...
        public void onProcess(double v, double v1, double v2, double v3, Object o) {
            String info = "上传进度 - 总计: "+v2+" 字节, 已上传: "+v3+" 字节\n";
            //Log.d(TAG,info);
            showInfo("process："+info);
...
//                          throw new RuntimeException(e);
    ...
    private void initRAASR(){
        mRAASR = new RAASR("", RegionType.CN_LLM_TYPE);
